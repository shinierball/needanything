...
/**
 * ## States
 * Needanything explicitly defines initial state
 *
 */
 ...
 *
 * ## Initial state
 * Create instances for the keys of each structure in needanything
...
export default function native (platform) {
  let Needanything = React.createClass({
    render () {
      const store = configureStore(getInitialState())

            // configureStore will combine reducers from needanything and main application
          ...
          <Router sceneStyle={{ backgroundColor: 'white' }}>
            <Scene key='root' hideNavBar>
              ...
              <Scene key='Tabbar'
                ...
                <Scene key='Logout'
                  title={I18n.t('Needanything.logout')}
                  icon={TabIcon}
                  iconName={'sign-out'}
                  hideNavBar
                  component={Logout} />
                ...
                <Scene key='Main'
                  title={I18n.t('Needanything.main')}
                  iconName={'home'}
                  icon={TabIcon}
                  hideNavBar
                  component={Main}
  ...
  AppRegistry.registerComponent('needanything', () => Needanything)
}
